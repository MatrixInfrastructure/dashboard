...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [MatrixInfrastructure](https://github.com/MatrixInfrastructure) open-source ecosystem.
...
The `dashboard` application is the web frontend for MatrixInfrastructure, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/MatrixInfrastructure/dashboard
cd dashboard
npm install
```
...
- **GitHub Issues:** [github.com/MatrixInfrastructure/issues](https://github.com/MatrixInfrastructure)
- **Discussions:** [github.com/MatrixInfrastructure/discussions](https://github.com/MatrixInfrastructure)
